...
run: # Run script for given year and day
	poetry run python -m aoc $(year) $(day)

new: # Create new module for given year and day
	poetry run python -m aoc $(year) $(day) --new

test: # Run tests, coverage and mypy
...
help: # Show this help
	...
	@echo -e "\033[0;31m > make new year=2020 day=1 \033[0m"
	@echo
